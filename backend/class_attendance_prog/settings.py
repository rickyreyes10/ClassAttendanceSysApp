...
SECRET_KEY = 'django-insecure-sm%pmccn4j%t=*e@!r!boh3@#8s+cnoquagy7d8uitkh)6)kq#'
...
# Age of session cookies in seconds. Default is 1209600 seconds (2 weeks).
# You can adjust this based on your application's requirements.
SESSION_COOKIE_AGE = 1209600

# This ensures that JavaScript cannot access the session cookie.
